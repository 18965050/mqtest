 ...
 */
package cn.xyz.lcg.rocketmq.broadcasting;
...
public class Producer {
	public static void main(String[] args) throws MQClientException, InterruptedException {
		DefaultMQProducer producer = new DefaultMQProducer("broadcastingProducer");
		...
		for (int i = 0; i < 1; i++) {
			try {
				Message msg = new Message("broadcastingTest", // topic
						"TagA", // tag
